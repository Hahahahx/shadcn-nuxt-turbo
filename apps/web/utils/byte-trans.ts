...
function k2g(KB = 0, fixed: Fixed = 'round') {
  return Math[fixed](KB / (1024 ** 2))
}

function k2t(KB = 0, fixed: Fixed = 'round') {
  return Math[fixed](KB / (1024 ** 3))
}

function k2m(KB = 0, fixed: Fixed = 'round') {
  return Math[fixed](KB / (1024 ** 1))
}

function m2k(MB = 0, fixed: Fixed = 'round') {
  return Math[fixed](MB * (1024 ** 1))
}

function m2g(MB = 0, fixed: Fixed = 'round') {
  return Math[fixed](MB / (1024 ** 1))
}

function m2t(MB = 0, fixed: Fixed = 'round') {
  return Math[fixed](MB / (1024 ** 2))
}

function g2k(GB = 0, fixed: Fixed = 'round') {
  return Math[fixed](GB * (1024 ** 2))
}

function g2m(GB = 0, fixed: Fixed = 'round') {
  return Math[fixed](GB * (1024 ** 1))
}

function g2t(GB = 0, fixed: Fixed = 'round') {
  return Math[fixed](GB / (1024 ** 1))
}

function t2k(TB = 0, fixed: Fixed = 'round') {
  return Math[fixed](TB * (1024 ** 3))
}

function t2m(TB = 0, fixed: Fixed = 'round') {
  return Math[fixed](TB * (1024 ** 2))
}

function t2g(TB = 0, fixed: Fixed = 'round') {
